...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/fivebitsio/cotton/internal/gen/proto/sdk/devices/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	DevicesServiceName = "sdk.devices.v1.DevicesService"
)
...
const (
	...
	// RPC.
	DevicesServiceSubscribeProcedure = "/sdk.devices.v1.DevicesService/Subscribe"
	// DevicesServiceUpdateStatusProcedure is the fully-qualified name of the DevicesService's
	// UpdateStatus RPC.
	DevicesServiceUpdateStatusProcedure = "/sdk.devices.v1.DevicesService/UpdateStatus"
	// DevicesServiceUpdateTokenProcedure is the fully-qualified name of the DevicesService's
	// UpdateToken RPC.
	DevicesServiceUpdateTokenProcedure = "/sdk.devices.v1.DevicesService/UpdateToken"
)

// DevicesServiceClient is a client for the sdk.devices.v1.DevicesService service.
...
// NewDevicesServiceClient constructs a client for the sdk.devices.v1.DevicesService service. By
...
func NewDevicesServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) DevicesServiceClient {
	...
	devicesServiceMethods := v1.File_sdk_devices_v1_devices_proto.Services().ByName("DevicesService").Methods()
...
// Subscribe calls sdk.devices.v1.DevicesService.Subscribe.
...
// UpdateStatus calls sdk.devices.v1.DevicesService.UpdateStatus.
...
// UpdateToken calls sdk.devices.v1.DevicesService.UpdateToken.
...
// DevicesServiceHandler is an implementation of the sdk.devices.v1.DevicesService service.
...
func NewDevicesServiceHandler(svc DevicesServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/sdk.devices.v1.DevicesService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedDevicesServiceHandler) Subscribe(context.Context, *connect.Request[v1.SubscribeRequest]) (*connect.Response[v1.SubscribeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sdk.devices.v1.DevicesService.Subscribe is not implemented"))
}
...
func (UnimplementedDevicesServiceHandler) UpdateStatus(context.Context, *connect.Request[v1.UpdateStatusRequest]) (*connect.Response[v1.UpdateStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sdk.devices.v1.DevicesService.UpdateStatus is not implemented"))
}
...
func (UnimplementedDevicesServiceHandler) UpdateToken(context.Context, *connect.Request[v1.UpdateTokenRequest]) (*connect.Response[v1.UpdateTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sdk.devices.v1.DevicesService.UpdateToken is not implemented"))
}
