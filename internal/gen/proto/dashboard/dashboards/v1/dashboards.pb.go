...
const (
	...
	DashboardTileViewMode_DASHBOARD_TILE_VIEW_MODE_PIE    DashboardTileViewMode = 8
	...
	DashboardTileViewMode_DASHBOARD_TILE_VIEW_MODE_MAP DashboardTileViewMode = 9
)
...
var (
	DashboardTileViewMode_name = map[int32]string{
		...
		8: "DASHBOARD_TILE_VIEW_MODE_PIE",
		9: "DASHBOARD_TILE_VIEW_MODE_MAP",
	}
	DashboardTileViewMode_value = map[string]int32{
		...
		"DASHBOARD_TILE_VIEW_MODE_PIE":         8,
		"DASHBOARD_TILE_VIEW_MODE_MAP":         9,
	}
)
...
const file_dashboard_dashboards_v1_dashboards_proto_rawDesc = "" +
	...
	"\x01w\x18\x03 \x01(\x05B\t\xbaH\x06\x1a\x04\x18H(\x01R\x01w\x12\x18\n" +
	"\x01h\x18\x04 \x01(\x05B\n" +
	"\xbaH\a\x1a\x05\x18\xa0\x06(\x01R\x01h:j\xbaHg\x1ae\n" +
	"\x16grid_position.complete\x12/position requires both w (1..72) and h (1..800)\x1a\x1ahas(this.w) && has(this.h)\"\xac\x02\n" +
	...
	"\tdashboard\x18\x01 \x01(\v2*.dashboard.dashboards.v1.RenderedDashboardR\tdashboard*\x8a\x03\n" +
	...
	"\x1fDASHBOARD_TILE_VIEW_MODE_SANKEY\x10\a\x12 \n" +
	"\x1cDASHBOARD_TILE_VIEW_MODE_PIE\x10\b\x12 \n" +
	"\x1cDASHBOARD_TILE_VIEW_MODE_MAP\x10\t*I\n" +
