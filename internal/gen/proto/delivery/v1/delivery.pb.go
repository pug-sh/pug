...
type RecordEventRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Core identifiers
	ProjectId      string `protobuf:"bytes,1,opt,name=project_id,json=projectId" json:"project_id,omitempty"`                // Project ID from notification payload
	CampaignId     string `protobuf:"bytes,2,opt,name=campaign_id,json=campaignId" json:"campaign_id,omitempty"`             // Campaign ID from notification payload
	MessageId      string `protobuf:"bytes,3,opt,name=message_id,json=messageId" json:"message_id,omitempty"`                // FCM message ID from notification
	SubscriptionId string `protobuf:"bytes,4,opt,name=subscription_id,json=subscriptionId" json:"subscription_id,omitempty"` // Subscription identifier
	// Event information
	EventType EventType `protobuf:"varint,5,opt,name=event_type,json=eventType,enum=delivery.v1.EventType" json:"event_type,omitempty"` // Type of event that occurred
	Platform  Platform  `protobuf:"varint,6,opt,name=platform,enum=delivery.v1.Platform" json:"platform,omitempty"`                     // Subscription platform
	...
	Metadata      map[string]string `protobuf:"bytes,8,rep,name=metadata" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Any additional data from subscription
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type BatchDeliveryEvents struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Events        []*RecordEventRequest  `protobuf:"bytes,1,rep,name=events" json:"events,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_delivery_v1_delivery_proto_rawDesc = "" +
	...
	"\x0fevent_timestamp\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x0eeventTimestamp\x12I\n" +
	"\bmetadata\x18\b \x03(\v2-.delivery.v1.RecordEventRequest.MetadataEntryR\bmetadata\x1a;\n" +
	...
	"\x13BatchUnicastMessage\"N\n" +
	"\x13BatchDeliveryEvents\x127\n" +
	"\x06events\x18\x01 \x03(\v2\x1f.delivery.v1.RecordEventRequestR\x06events*L\n" +
	"\bPlatform\x12\x18\n" +
