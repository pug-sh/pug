...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/fivebitsio/cotton/internal/gen/proto/delivery/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	DeliveryServiceName = "delivery.v1.DeliveryService"
)
...
func NewDeliveryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) DeliveryServiceClient {
	...
	deliveryServiceMethods := v1.File_delivery_v1_delivery_proto.Services().ByName("DeliveryService").Methods()
