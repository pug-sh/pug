...
// MagicLinkTokenPurpose is the email_action_tokens.purpose for magic-link tokens.
// Shared so invite issuance (orgs) and CompleteMagicLink (auth) cannot drift.
const MagicLinkTokenPurpose = "magic_link"
