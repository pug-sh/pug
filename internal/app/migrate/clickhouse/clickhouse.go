...
func Up(ctx context.Context, num int) error {
	...
	slog.InfoContext(ctx, "applied clickhouse migrations", slog.Int("appliedMigrations", num))
	return nil
}
...
func Down(ctx context.Context, num int) error {
	...
	slog.InfoContext(ctx, "rolled back clickhouse migrations", slog.Int("rolledBackMigrations", num))
	return nil
}
