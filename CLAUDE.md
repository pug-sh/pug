...
# void is the only way to stop a charge before it happens, or to record that a
# paid one was refunded in the provider's dashboard; it never calls the provider.
