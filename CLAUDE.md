...
# An empty --until CLEARS the contract and the overrides it gated, exactly as
# omitting the flag does; a real date on a floor plan is a comped grant and keeps
# them.
