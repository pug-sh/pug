...
# its empty value (--events 0, --name "", --anchor-day 0, --until "") clears it.
...
./bin/pug billing set o_2f9k --plan custom --events 5000000 --name "Acme Enterprise" \
                             --provider-product prod_2f9k --until 2027-01-01 \
                             --note '$400/mo, INV-123' --actor "praveen/INV-123"
